...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1161, 864)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.slider_videoframe = QtWidgets.QSlider(self.centralwidget)
        self.slider_videoframe.setGeometry(QtCore.QRect(376, 740, 691, 51))
        ...
        self.video_widget.setGeometry(QtCore.QRect(36, 180, 1101, 471))
        self.video_widget.setStyleSheet("background-color: rgb(188, 188, 188);")
        self.video_widget.setObjectName("video_widget")
        self.button_stop = QtWidgets.QPushButton(self.centralwidget)
        self.button_stop.setGeometry(QtCore.QRect(226, 660, 191, 51))
        font = QtGui.QFont()
...
"border:2px solid gray;")
        ...
        self.label.setGeometry(QtCore.QRect(6, -6, 1161, 851))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
...
"}")
        ...
        self.button_warning.setGeometry(QtCore.QRect(786, 660, 191, 51))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
...
"border:2px solid gray;")
        ...
        self.button_rd.setGeometry(QtCore.QRect(600, 660, 191, 51))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(18)
...
"border:2px solid gray;")
        ...
        self.button_pause.setGeometry(QtCore.QRect(410, 660, 191, 51))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(18)
...
"border:2px solid gray;")
        ...
        self.button_play.setGeometry(QtCore.QRect(40, 660, 191, 51))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(24)
...
"")
        ...
        self.button_openfile.setGeometry(QtCore.QRect(186, 740, 111, 41))
        ...
        self.button_shot.setGeometry(QtCore.QRect(1016, 660, 121, 51))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(24)
...
"")
        ...
        self.warning_left.setGeometry(QtCore.QRect(70, 20, 150, 150))
        ...
        self.warning_middle.setGeometry(QtCore.QRect(520, 20, 150, 150))
        ...
        self.warning_right.setGeometry(QtCore.QRect(940, 20, 150, 150))
